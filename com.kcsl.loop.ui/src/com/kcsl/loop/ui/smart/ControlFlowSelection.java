...
public class ControlFlowSelection {
	...
	public static ControlFlowSelection processSelection(IAtlasSelectionEvent atlasSelection) {
		...
		Q selectedMethods = selected.nodes(XCSG.Method);
		Q selectedDataFlow = selected.nodes(XCSG.DataFlow_Node);
		Q selectedControlFlow = selected.nodes(XCSG.ControlFlow_Node);		
