...
public class LoopReachabilityToDataFlow extends FilteringAtlasSmartViewScript implements AtlasSmartViewScript {
	...
	public String getTitle() {
		return "RULER Reachable Loops (To Input)";
	}
	...
	public StyledResult selectionChanged(IAtlasSelectionEvent event, Q input) {
		...
		Q view = LoopReachability.getLoopReachabilityViaDataFlowView(input, false);
