...
/**
 * Filters loops headers that match with IO Parameter Pattern
 * 
 * @author Payas Awadhutkar
 */

public class IOParameterFilter extends NodeFilter {

	private static final String EXCLUDE_MATCHES = "EXCLUDE_MATCHES";

	public IOParameterFilter() {
	...
	public String getDescription() {
		return "Filters loops by boundary conditions that depend on IO parameters.";
	}
	...
	public Q filter(Q input, Map<String, Object> parameters) throws InvalidFilterParameterException {
		...
		Q matches = input.nodes(LoopPatternConstants.MONOTONICITY_PATTERN_IO_PARAMETER);
