...
/**
 * Filters loops headers that match with Field Array Pattern
 * 
 * @author Payas Awadhutkar
 */

public class FieldArrayLoopPatternFilter extends NodeFilter {

	private static final String EXCLUDE_MATCHES = "EXCLUDE_MATCHES";

	public FieldArrayLoopPatternFilter() {
	...
	public String getDescription() {
		return "Filters loops by boundary conditions that depend on field arrays.";
	}
	...
	public Q filter(Q input, Map<String, Object> parameters) throws InvalidFilterParameterException {
		...
		Q matches = input.nodes(LoopPatternConstants.MONOTONICITY_PATTERN_FIELD_ARRAY);
