...
/**
 * Filters loops headers that match with IO Field Pattern
 * 
 * @author Payas Awadhutkar
 */

public class IOFieldFilter extends NodeFilter {

	private static final String EXCLUDE_MATCHES = "EXCLUDE_MATCHES";

	public IOFieldFilter() {
	...
	public String getDescription() {
		return "Filters loops by boundary conditions that depend on IO fields.";
	}
	...
	public Q filter(Q input, Map<String, Object> parameters) throws InvalidFilterParameterException {
		...
		Q matches = input.nodes(LoopPatternConstants.MONOTONICITY_PATTERN_IO_FIELD);
