...
/**
 * Filters loops headers that match with Parameter Collection Pattern
 * 
 * @author Payas Awadhutkar
 */

public class ParameterCollectionLoopPatternFilter extends NodeFilter {

	private static final String EXCLUDE_MATCHES = "EXCLUDE_MATCHES";

	public ParameterCollectionLoopPatternFilter() {
	...
	public String getDescription() {
		return "Filters loops by boundary conditions that depend on parameter collections.";
	}
	...
	public Q filter(Q input, Map<String, Object> parameters) throws InvalidFilterParameterException {
		...
		Q matches = input.nodes(LoopPatternConstants.MONOTONICITY_PATTERN_PARAMETER_COLLECTION);
