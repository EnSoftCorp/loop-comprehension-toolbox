...
/**
 * Filters loops headers that match with IO Local Pattern
 * 
 * @author Payas Awadhutkar
 */

public class IOLocalFilter extends NodeFilter {

	private static final String EXCLUDE_MATCHES = "EXCLUDE_MATCHES";

	public IOLocalFilter() {
	...
	public String getDescription() {
		return "Filters loops by boundary conditions that depend on IO locals.";
	}
	...
	public Q filter(Q input, Map<String, Object> parameters) throws InvalidFilterParameterException {
		...
		Q matches = input.nodes(LoopPatternConstants.MONOTONICITY_PATTERN_IO_LOCAL);
