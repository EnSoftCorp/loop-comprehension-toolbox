...
/**
 * Filters loops headers that match with Local Collection Pattern
 * 
 * @author Payas Awadhutkar
 */

public class LocalCollectionLoopPatternFilter extends NodeFilter {

	private static final String EXCLUDE_MATCHES = "EXCLUDE_MATCHES";

	public LocalCollectionLoopPatternFilter() {
	...
	public String getDescription() {
		return "Filters loops by boundary conditions that depend on local collections.";
	}
	...
	public Q filter(Q input, Map<String, Object> parameters) throws InvalidFilterParameterException {
		...
		Q matches = input.nodes(LoopPatternConstants.MONOTONICITY_PATTERN_LOCAL_COLLECTION);
