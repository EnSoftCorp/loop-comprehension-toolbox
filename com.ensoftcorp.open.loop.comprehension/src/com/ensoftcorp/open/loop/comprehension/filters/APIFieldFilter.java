...
/**
 * Filters loops headers that match with API Field Pattern
 * 
 * @author Payas Awadhutkar
 */

public class APIFieldFilter extends NodeFilter {
	...
	public String getDescription() {
		return "Filters loops by boundary conditions that depend on an API field.";
	}
	...
	public Q filter(Q input, Map<String, Object> parameters) throws InvalidFilterParameterException {
		...
		Q matches = input.nodes(LoopPatternConstants.MONOTONICITY_PATTERN_API_FIELD);
