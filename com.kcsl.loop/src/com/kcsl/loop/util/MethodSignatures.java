...
public interface MethodSignatures {
	...
	public static final Set<String> ITERATOR_APIs = new HashSet<>(Arrays.asList(new String[] {
	...
	public static final Set<String> COLLECTION_APIs = new HashSet<>(Arrays.asList(new String[] {
			SIGNATURE_LIST_ADD,
	 ...
	 */
	public static final Set<String> INCREMENT_APIs = new HashSet<>(Arrays.asList(new String[] {
			SIGNATURE_ITERATOR_NEXT,
			SIGNATURE_ENUMERATION_NEXTELEMENT,
	 ...
	 */
	public static final Set<String> DECREMENT_APIs = new HashSet<>(Arrays.asList(new String[] {
			SIGNATURE_ITERATOR_REMOVE,
			SIGNATURE_LIST_REMOVE,
			SIGNATURE_LIST_REMOVEALL,
			SIGNATURE_LIST_CLEAR,
	 ...
	 */
	public static final Set<String> IO_APIs = new HashSet<>(Arrays.asList(new String[] {
			SIGNATURE_READLINE,
			 IO_CANREAD,
			 IO_READBOOLEAN, 
			 IO_READBYTE,
